 ...
 *
 * Copyright (C) 2020 https://www.frontuari.net and contributors (see README.md file).
 */

package net.frontuari.customcreatefrom.util;

import static net.frontuari.customcreatefrom.test.util.RandomTestUtil.*;
import static net.frontuari.customcreatefrom.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"net.frontuari.customcreatefrom.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"net.frontuari.customcreatefrom.util\"");
	}
