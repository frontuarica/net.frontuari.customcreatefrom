...
call mvn validate -Didempiere.target=net.frontuari.customcreatefrom.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=net.frontuari.customcreatefrom.p2.targetplatform %DEBUG_MODE%
