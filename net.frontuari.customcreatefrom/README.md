# net.frontuari.customcreatefrom

## Standard

- New callout
    * Name: CName
    * Package: net.frontuari.customcreatefrom.callout
    * Example: net.frontuari.customcreatefrom.callout.CStringFormat

- New process
    * Name: PName
    * Package: net.frontuari.customcreatefrom.process
    * Example: net.frontuari.customcreatefrom.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: net.frontuari.customcreatefrom.form
    * Example: net.frontuari.customcreatefrom.form.FMultiPayment

- New event
    * Name: EName
    * Package: net.frontuari.customcreatefrom.event
    * Example: net.frontuari.customcreatefrom.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: net.frontuari.customcreatefrom.model
    * Example: net.frontuari.customcreatefrom.model.MTableExample
...
```
    net.frontuari.customcreatefrom
        ...
        |   |_ProcessFactory.xml
        |_src
            |_net.frontuari.customcreatefrom
                |_base (plugin core)
...
- New callout
    * Create callout in package `net.frontuari.customcreatefrom.callout`, extends from `CustomCallout`
    * Register callout in `net.frontuari.customcreatefrom.component.CalloutFactory`. Example:
...
- New process
    * Create process in package `net.frontuari.customcreatefrom.process`, extends from `CustomProcess`
    * Register process in `net.frontuari.customcreatefrom.component.ProcessFactory`. Example:
...
- New form
    * Create form in package `net.frontuari.customcreatefrom.form`, extends from `CustomForm`
    * Register form in `net.frontuari.customcreatefrom.component.FormFactory`. Example:
...
- New event
    * Create event in package `net.frontuari.customcreatefrom.event`, extends from `CustomEvent`
    * Register event in `net.frontuari.customcreatefrom.component.EventFactory`. Example:
...
- New model (extends form class X)
    * Create model in package `net.frontuari.customcreatefrom.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
    * Register model in `net.frontuari.customcreatefrom.component.ModelFactory`. Example:
